...
class Home extends Component {
  ...
  `;
    console.log(this.state, this.state.isIpad, this.state.screenWidth);
    if (this.state.screenWidth <= 1024 && !this.state.isMobile) {
      if (window.matchMedia("(orientation: portrait)").matches) {
        // you're in PORTRAIT mode
        this.setState({ span: 10, isIpad: 1 });
      } else {
        this.setState({ span: 14, isIpad: 1 });
      }
    }
                  ...
                  >
                    <Col span={span}>
                      <Element name="experience" className="element">
                        <Experience
                          fontSize={this.state.smallIconSize}
                          isMobile={this.state.isMobile}
                        ></Experience>
                      </Element>
                    </Col>
                    ...
                    <Col span={span}>
                      <Element name="projects" className="element">
                        <Projects
                          fontSize={this.state.smallIconSize}
                          isMobile={
                            this.state.isIpad === 1 ? true : this.state.isMobile
                          }
                          screenWidth={this.state.screenWidth}
                        ></Projects>
                      </Element>
