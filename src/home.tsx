...
import Medium from "./modules/publications/medium";
...
const NetlifyIcon = (props: any) => <Icon component={NetlifySvg} {...props} />;
...
const Home: React.FC<HomeProps> = ({ screenWidth, iconSize, smallIconSize, isMobile }) => {
  const [loader, setLoader] = useState(true)
  const [span, setSpan] = useState(16)
  const [isIpad, setIsIpad] = useState(-1)


  const sleep = (milliseconds: number) => {
    return new Promise((resolve) => setTimeout(resolve, milliseconds));
  };
  const handleLoad = async (milliseconds: number) => {
      ...
      <>
        <Layout style={{ background: "transparent" }}>
          ...
          <Layout style={{ background: "transparent" }}>
            <Content
              style={
                screenWidth > 600 && isMobile === false
              ...
              <Row type="flex" justify="center" align="middle">
                <Col span={8} offset={2}>
                  <Row type="flex" justify="space-between" align="middle">
                    <a
                      href="https://github.com/CryogenicPlanet"
                      target="_blank"
                    ...
                    <a
                      href="https://www.linkedin.com/in/rahul-tarak/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Icon
                    ...
                    <a
                      href="https://www.youtube.com/channel/UC49yeT9WnpVdIdmo4ZYUteQ"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Icon
                    ...
                    <a
                      href="https://medium.com/@rahultarak"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Icon
            ...
            <Footer>
              <Row type="flex" justify="center" align="middle">
                <Paragraph>
                  {" "}
                  {`<> `} with <HeartIcon style={{ color: "hotpink" }} /> by{" "}
                  <a
                    href="https://github.com/CryogenicPlanet"
                    target="_blank"
                    rel="noopener noreferrer"
