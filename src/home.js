...
class Home extends Component {
  state = {
    ...
    smallIconSize : this.props.smallIconSize,
          ...
          <Layout style={{ background: "transparent" }}>
            ...
            <Content style={this.state.screenWidth > 600 && this.state.isMobile === false ? { background: "transparent" } : {background : "#212121"}} name="home">
              ...
              <Col lg={{span : 10, offset : 5}} sm={{span : 10, offset : 3}}>
                ...
                >
                  <Animator screenWidth={this.state.screenWidth} isMobile={this.state.isMobile}></Animator>
                </Paper>
                </Col>
              </Row>
              ...
              <Col span={10} offset={5}>
                <Paper elevation={0} style={{ background: "transparent" }}>
                  <NameDrawer screenWidth={this.state.screenWidth} isMobile={this.state.isMobile}></NameDrawer>
                </Paper>
                </Col>
              </Row>
              <Row type="flex" justify="center" align="middle">
              ...
              <a href="https://github.com/CryogenicPlanet" target="_blank" rel="noopener noreferrer"><Icon type="github" style={{fontSize : this.state.iconSize}}/></a>
              ...
              <Row  type="flex" justify="center" align="middle">
                  ...
                  <About screenWidth={this.state.screenWidth} isMobile={this.state.isMobile}></About>
                ...
                <Row  type="flex" justify="center" align="middle" style={{paddingTop : "5%"}}>
                    <Col span={16}>
                      <Element name="experience" className="element">
                        <Experience fontSize={this.state.smallIconSize} isMobile={this.state.isMobile}></Experience>
                      </Element>
                    </Col>
                </Row>
              </Paper>
                ...
                <Row  type="flex" justify="center" align="middle" style={{paddingTop : "5%"}}>
                    <Col span={16}>
                      <Element name="projects" className="element">
                        <Projects fontSize={this.state.smallIconSize} isMobile={this.state.isMobile} screenWidth={this.state.screenWidth}></Projects>
                      </Element>
                    </Col>
                </Row>
              </Paper>
                ...
                <Row  type="flex" justify="center" align="middle" style={{paddingTop : "5%"}}>
                    <Col span={16}>
                      ...
                      <Row  type="flex" justify="center" align="middle" style={{paddingTop : "1%"}}>
                        ...
                        <Skills screenWidth={this.state.screenWidth} isMobile={this.state.isMobile}></Skills>
                      </Element>
                    </Col>
                </Row>
              </Paper>
